		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'diy_image'        => ('' != $product['image_code']) ? $this->url->link('tool/upload/download', 'user_token=' . $this->session->data['user_token'] . '&code=' . $product['image_code'], true) : '',
					'diy_image_preview' => ('' != $product['image_code']) ? $this->url->link('tool/upload/preview', 'user_token=' . $this->session->data['user_token'] . '&code=' . $product['image_code'], true) : '',
				);
			}
