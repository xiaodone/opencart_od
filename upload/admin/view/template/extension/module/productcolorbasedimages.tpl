      ...
      <div class="panel-body">		
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">        
          ...
          <div class="pcoi_form_widget">
              ...
              <div class="col-sm-10">
                <select name="add_color" id="add_color" class="form-control">
                  ...
                  <?php foreach ($option as $optn) { ?>
                    <option value="<?php echo $optn['option_id']; ?>" <?php echo $optn['sel'];  ?>><?php echo $optn['option']; ?></option>
                  <?php } ?>
                </select>              
              </div>
            </div>
            ...
            <?php $loop_length = (count($result_color_f)? count($result_color_f) : 2 ); ?>
            <?php for($i=1; $i<= $loop_length ; $i++) { ?>
                ...
                <div class="col-sm-4">
                  <select name='<?php echo "map_filter_option_".$i; ?>' id="input-map_filter_option" class="form-control">
                    ...
                    <?php foreach ($filter as $optn) { ?>
                      <option value="<?php echo $optn['filter_id']; ?>" 
                      <?php if(isset($result_filter_opt_val_id[$i])) {
            ...
            <div class="form-group">                        
              <div class="text-right col-sm-12">
                <button type="button" id="add_fil_to_col" data-toggle="tooltip" title="" class="btn btn-primary">
              ...
              <script>
                jQuery(document).ready(function($){
                  ...
                  var filter_to_color_index = <?php echo count($result_color_f); ?>+1;
                  ...
                  var html='<div class="form-group">'+
                        ...
                        '<div class="col-sm-4">'+
                          '<select name="map_filter_option_'+filter_to_color_index+'" id="input-map_filter_option" class="form-control">'+
                           '<option value="">---Select---</option>';
                            <?php foreach($filter as $optn) { ?>
                              html+='<option value="<?php echo $optn['filter_id']; ?>" ';                              
                              html+='><?php echo $optn['filter']; ?>'+
                                    '</option>';
                          <?php } ?>
                          html+='</select>'+
                        '</div>'+
            ...
            <?php $loop_length = ( count($result_color) ? count($result_color) : 2 ); ?>
            <?php for ( $i=1 ; $i <= $loop_length; $i++ ) { ?>
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name='<?php echo "map_option_value_ids_option_".$i; ?>' id="input-option_value_ids_option" class="form-control">
                    ...
                    <?php foreach ($product_option_value as $optn_value_id) { ?>
                      <option value="<?php echo $optn_value_id['option_value_id']; ?>" 
                        <?php if($optn_value_id['option_value_id']==$result_product_opt_val_id[$i])
            ...
            <div class="form-group">                        
              <div class="text-right col-sm-12">
                <button type="button" id="add_col_to_map" data-toggle="tooltip" title="" class="btn btn-primary">
                  <i class="fa fa-plus-circle"></i>
                </button>
              </div>
              <script>
                jQuery(document).ready(function($){
                  ...
                  var color_to_map = <?php echo count($result_color); ?>+1;
                  ...
                  var html='<div class="form-group">'+
                        ...
                        '<div class="col-sm-4">'+
                          '<select name="map_option_value_ids_option_'+color_to_map+'" id="input-option_value_ids_option" class="form-control">'+
                           '<option value="">---Select---</option>';
                            <?php foreach($product_option_value as $optn_value_id) { ?>
                              html+='<option value="<?php echo $optn_value_id['option_value_id']; ?>" ';                              
                              html+='><?php echo $optn_value_id['name']; ?>'+
                                    '</option>';
                          <?php } ?>
                          html+='</select>'+
                        '</div>'+
          ...
          <div class="pcoi_selection_widget" style="display:none;">
            ...
            <iframe id="product_selection_zone" src="<?php echo $base_url; ?>index.php?route=product/product&product_id=<?php echo $product_id; ?>" style="height:100%; width:100%;margin-top:2em;"></iframe>
          </div>
