...
$_['text_edit']           = 'Alterar opção';

$_['text_choose']         = 'Com opção de seleção';

$_['text_select']         = 'Menu de seleção';

$_['text_radio']          = 'Seleção única';

$_['text_checkbox']       = 'Seleção multipla';

$_['text_image']          = 'Imagem';

$_['text_input']          = 'Campo de texto simples';

$_['text_text']           = 'Texto numa linha';
...
$_['error_permission']    = 'Atenção: Não tem permissão para modificar as opções!';
...
$_['error_product']       = 'Atenção: Esta opção não pode ser removida, pois está associada a %s produtos!';