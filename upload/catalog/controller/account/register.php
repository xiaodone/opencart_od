...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $validate) {
			...
			if (isset($this->request->post['type']) && $this->request->post['type'] == 'api') {
		...
		}elseif (isset($this->request->post['type']) && $this->request->post['type'] == 'api') {
			return $validate;
		}else{
	...
	private function validate() {
		...
		if(isset($this->request->post['type']) && $this->request->post['type'] == 'api') {
			if($this->error) {//var_export($this->error);
				$this->response->addHeader('Content-Type: application/json');
				$this->response->setOutput(json_encode([
